...
public class Nivel{
    ...
    /**
     * Función que retorna los puntos que da matar al alien
     * @param ind1 Entero con el indice en la fila del alien
     * @param ind2 Entero con el indice en la columna del alien
    ...
    /**
     * Función para obtener si un alien aún vive
     * @param ind1 Entero con el indice en la fila del alien
     * @param ind2 Entero con el indice en la columna del alien
    ...
    /**
     * Función para cambiar la vida de los bunkers
